...
- Shortcuts like Id::, Name::, ClassName::, Selector::
  More: [Element Finder]([[docsref:/action/element-finder]])

#### Q: How do I add a new action?

Open your Configuration → Actions → Add. Set the Finder, choose the Value (what to do), and adjust timing or conditions if needed. Details: [Action Settings]([[docsref:/action/action-settings]])
...
A delay before an action or configuration starts. Set 0 for no delay. [Timing]([[docsref:/action/overview#init-wait]])
...
Yes. Use Batch Repeat. A value of -2 means repeat forever. [Batch Repeat]([[docsref:/configuration/batch#repeat]])
...
Learn more: [Configuration URL]([[docsref:/configuration/url]])
...
Use `GoogleSheets::Sheet1!A1` as the Value. First, connect in Global Settings → Google Sheets. [Google Sheets]([[docsref:/action-value/google-sheets]])
