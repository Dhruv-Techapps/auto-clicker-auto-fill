...
export const CONFIGURATIONS: IConfiguration[] = [
  {
    ...
    loadType: 'window',
    name: 'Sample Automation | Auto click / Auto Fill',
    source: 'wizard',
    startType: 'auto',
    timer: 1736353844887,
    updated: true,
  ...
  } as IConfiguration,
  {
    ...
    loadType: 'window',
    name: 'Sample Automation | Google Sheets',
    source: 'web',
  ...
  } as IConfiguration,
  {
    ...
    initWait: 5,
    loadType: 'window',
    name: 'Sample Automation | Query Param',
    source: 'web',
    startType: 'auto',
    updated: true,
