...
import { MicrosoftOauth2Background, RUNTIME_MESSAGE_MICROSOFT_OAUTH } from '@dhruv-techapps/shared-microsoft-oauth';
import { MicrosoftExcelBackground, RUNTIME_MESSAGE_MICROSOFT_EXCEL } from '@dhruv-techapps/shared-microsoft-excel';
...
try {
  ...
  const onMessageListener = {
    ...
    [RUNTIME_MESSAGE_MICROSOFT_OAUTH]: new MicrosoftOauth2Background(EDGE_OAUTH_CLIENT_ID),
    [RUNTIME_MESSAGE_MICROSOFT_EXCEL]: new MicrosoftExcelBackground(auth, FIREBASE_FUNCTIONS_URL, EDGE_OAUTH_CLIENT_ID),
