...
import { handleError, OpenTelemetryBackground, RUNTIME_MESSAGE_OPEN_TELEMETRY, SpanKind, tracer } from '@dhruv-techapps/core-open-telemetry/background';
  ...
  (span) => {
    try {
      ...
      const onMessageListener = {
        ...
        [RUNTIME_MESSAGE_OPEN_TELEMETRY]: new OpenTelemetryBackground()
      };
      ...
      handleError(span, error, 'Error in setting up background listeners');
    } finally {
      span.end();
    }
  }
