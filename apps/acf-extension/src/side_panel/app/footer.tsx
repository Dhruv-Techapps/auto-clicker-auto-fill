    ...
    <footer className='modal-footer justify-content-center' id='collapse-footer'>
      <ul className='nav justify-content-between w-100'>
        <li className='nav-item'>
          <a href='https://getautoclicker.com/docs' className='nav-link px-2 text-muted' target='_blank'>
        ...
        <li className='nav-item'>
          <a href='https://discord.gg/ubMBeX3' className='nav-link px-2 text-muted' target='_blank'>
        ...
        <li className='nav-item'>
          <a href={`${OPTIONS_PAGE_URL}`} className='nav-link px-2 text-muted' target='_blank' id='settings'>
        ...
        <li className='nav-item'>
          <a href='https://github.com/sponsors/Dhruv-Techapps' className='nav-link px-2 text-muted' target='_blank'>
