...
2. Right-click Element → On the page, right-click the element you want → select Inspect.
   • Shortcut: Cmd + Option + I opens DevTools.
   • Cmd + Shift + C lets you directly pick an element by hovering.
...
2. Right-click Element → On the page, right-click → choose Inspect.
   • Shortcut: Ctrl + Shift + I opens DevTools.
